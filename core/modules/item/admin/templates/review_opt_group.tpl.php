...
<form method="post" action="<?=cpurl($module, $act, 'save')?>">
    ...
    <div class="space">
        ...
        <?if($_GET['op']=='edit'):?>
        <ul class="cptab">
            <li class="selected"><a href="<?=cpurl($module,'review_opt_group','edit',array('gid'=>$gid))?>" onfocus="this.blur()">编辑属性组</a></li>
            <li><a href="<?=cpurl($module,'review_opt','',array('gid'=>$gid))?>" onfocus="this.blur()">值管理</a></li>
        </ul>
        <?endif;?>
    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            ...
            <tr>
                ...
                <td><?=$val['des']?></td>
                <td>
                    <a href="<?=cpurl($module, 'review_opt','',array('gid'=>$val['gid']))?>">点评项管理</a>&nbsp;
                    <a href="<?=cpurl($module, $act,'edit',array('gid'=>$val['gid']))?>">编辑</a>&nbsp;
                    <a href="<?=cpurl($module, $act,'delete',array('gid'=>$val['gid']))?>" onclick="return confirm('您确定要进行删除操作码？')">删除</a>
                </td>
            </tr>
            <? endwhile; ?>
            <? else: ?>
