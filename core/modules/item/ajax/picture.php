...
case 'get':
    ...
    $select = 'picid,uid,username,title,thumb,filename';
    ...
    if($list) {
        ...
        while($val = $list->fetch_array()) {
            ...
            echo "\t<td class=\"pic\"><a href=\"$url\" target=\"_blank\" title=\"$val[title]\"><img onmouseover=\"tip_start(this);\" src=\"$thumb\" /></a></td>";
        }
