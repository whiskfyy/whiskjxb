...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                <td class="altbg1"><strong>允许商家发布:</strong>设置优惠券只允许拥有商铺的管理员（店主）发布。<span class="font_1">本功能设置后，会员组内的相关权限将失效。</span></td>
                <td><?=form_bool('modcfg[post_item_owner]',$modcfg['post_item_owner'])?></td>
            </tr>
            <tr>
                <td class="altbg1"><strong>优惠券水印:</strong>是否在优惠券上加入水印，注意：加了水印的优惠券可能失效。</td>
