...
default:
    ...
    list($total,$list) = $EX->find('exchangeid,giftid,giftname,uid,username,price,number,exchangetime,status',
        array('status'=>$status),array('exchangetime'=>'DESC'),$start,$offset,true);
    if($total) {
