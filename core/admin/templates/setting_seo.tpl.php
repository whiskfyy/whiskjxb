...
<?=form_begin(cpurl($module,$act,$op))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            <tr>
                <td width="50%" class="altbg1"><strong>启用 URL 改写:</strong>URL 改写可以提高搜索引擎抓取，单会轻微增加服务器负担。<br /><span class="font_1">URL 改写，必须在模板中使用 url 模板标签，<a href="http://www.modoer.com/article.php?aid=38" target="_blank">详细使用请参考相关教程</a></span></td>
                <td width="*">
