...
$coreDir = substr(dirname(__FILE__),0,strpos(dirname(__FILE__),'error'));

require $coreDir.'/core/init.php';
...
EOT;
    if($js) {
    print <<< EOT
<script type="text/javascript" src="../data1/cachefiles/config.js"></script>
<script type="text/javascript" src="../static/javascript/jquery.js"></script>
